...
List<String> employees = employeeList.stream ().filter (elist -> elist.getDoj ().isAfter (LocalDate.*of* (2017, 01, 01))).map (Employee::getEmpName).collect(*toList*());
...
**25**.**/**Get highest salary from each department**/**
